...
#GIT_TAG = "RC1.6.0a"
#SRC_URI = "git://github.com/rdkcentral/RdkVlanBridgingManager.git;branch=1.6.0-main;protocol=https;name=VlanBridgingManager;tag=${GIT_TAG}"
#PV = "${GIT_TAG}+git${SRCPV}"

# Please use below part only for release verification/testing
SRC_URI = "git://github.com/rdkcentral/RdkVlanBridgingManager.git;branch=1.6.0-main;protocol=https;name=VlanBridgingManager;"
SRCREV = "${AUTOREV}"
