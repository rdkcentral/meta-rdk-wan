...
GIT_TAG = "v1.6.0"
SRC_URI = "git://github.com/rdkcentral/vlan-managerr.git;branch=main;protocol=https;name=VlanBridgingManager;tag=${GIT_TAG}"
PV = "${GIT_TAG}+git${SRCPV}"

# Please use below part only for release verification/testing
#SRC_URI = "git://github.com/rdkcentral/vlan-managerr.git;branch=releases/1.6.0-main;protocol=https;name=VlanBridgingManager;"
#SRCREV = "${AUTOREV}"
