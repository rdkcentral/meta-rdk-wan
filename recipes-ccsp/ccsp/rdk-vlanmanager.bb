...
SRC_URI = "git://github.com/rdkcentral/RdkVlanBridgingManager.git;branch=main;protocol=https;name=VlanBridgingManager"
SRCREV_VlanBridgingManager = "v1.0.0"

PV = "${SRCREV_VlanBridgingManager}"
