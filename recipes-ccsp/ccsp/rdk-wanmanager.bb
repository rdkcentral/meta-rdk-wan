...
#GIT_TAG = "RC2.11.0a"
#SRC_URI := "git://github.com/rdkcentral/RdkWanManager.git;branch=2.11.0-main;protocol=https;name=WanManager;tag=${GIT_TAG}"
#PV = "${GIT_TAG}+git${SRCPV}"

# Please use below part only for release verification/testing
SRC_URI := "git://github.com/rdkcentral/RdkWanManager.git;branch=2.11.0-main;protocol=https;name=WanManager;"
SRCREV = "${AUTOREV}"
